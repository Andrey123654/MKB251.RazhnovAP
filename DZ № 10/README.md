...
Суть уязвимости:
Уязвимость позволяет непривилегированному пользователю заставить процесс WUDFHost.exe (Windows Driver Foundation), работающий с привилегиями LOCAL SERVICE, загрузить произвольную DLL-библиотеку путем манипуляции COM-объектами через недокументированную функцию _SHCoCreateInstance из windows.storage.dll.
